...
import Extensions.MLMSettings as MLSettings
...
from SMLabel.libs.combobox import ComboBox
from SMLabel.libs.default_label_combobox import DefaultLabelComboBox
from SMLabel.libs.resources import *
from SMLabel.libs.constants import *
from SMLabel.libs.utils import *
from SMLabel.libs.settings import Settings
from SMLabel.libs.shape import Shape, DEFAULT_LINE_COLOR, DEFAULT_FILL_COLOR
from SMLabel.libs.stringBundle import StringBundle
from SMLabel.libs.canvas import Canvas
from SMLabel.libs.zoomWidget import ZoomWidget
from SMLabel.libs.lightWidget import LightWidget
from SMLabel.libs.labelDialog import LabelDialog
from SMLabel.libs.colorDialog import ColorDialog
from SMLabel.libs.labelFile import LabelFile, LabelFileError, LabelFileFormat
from SMLabel.libs.toolBar import ToolBar
from SMLabel.libs.pascal_voc_io import PascalVocReader
from SMLabel.libs.pascal_voc_io import XML_EXT
from SMLabel.libs.yolo_io import YoloReader
from SMLabel.libs.yolo_io import TXT_EXT
from SMLabel.libs.create_ml_io import CreateMLReader
from SMLabel.libs.create_ml_io import JSON_EXT
from SMLabel.libs.ustr import ustr
from SMLabel.libs.hashableQListWidgetItem import HashableQListWidgetItem

__appname__ = 'MLMAnnotation'
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename= None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        self.label_file_format = LabelFileFormat.YOLO #settings.get(SETTING_LABEL_FILE_FORMAT, LabelFileFormat.PASCAL_VOC)
    ...
    def open_dir_dialog(self, _value=False, dir_path=None, silent=False):
        ...
        #Shafi Investigate more why target got changed.
        self.default_save_dir = MLSettings.TRAIN_LABEL_DIRECTORY #target_dir_path
        if self.file_path:
...
def training_app(image_directory=None, class_file_directory= None, label_directory = None):
    """
    ...
    if image_directory is not None:
        MLSettings.TRAIN_IMAGE_DIRECTORY = image_directory

    if class_file_directory is not None:
               MLSettings.CLASS_FILE_DIRECORY = class_file_directory
    if label_directory is None:
         MLSettings.TRAIN_LABEL_DIRECTORY = label_directory
    # Usage : MLMAnnotation.py image classFile saveDir
    win = MainWindow(MLSettings.TRAIN_IMAGE_DIRECTORY,
                     MLSettings.CLASS_FILE_DIRECORY,
                     MLSettings.TRAIN_LABEL_DIRECTORY)
    win.show()
    return app, win

def run_training_main(image_location=None, class_file= None, label_location = None):
    app, _win = training_app(image_directory = image_location, class_file_directory = class_file, label_directory = label_location)
    return app.exec_()
